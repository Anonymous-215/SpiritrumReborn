...
namespace SpiritrumReborn.Content.Items.Accessories
{
    public class VoidClaws : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetKnockback(DamageClass.Melee) += 1.0f; 
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<EternalGauntlet>())
    ...
    public class VoidClawsPlayer : ModPlayer
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                target.AddBuff(ModContent.BuffType<Content.Debuffs.VoidFlames>(), 300); 
            }
        }
